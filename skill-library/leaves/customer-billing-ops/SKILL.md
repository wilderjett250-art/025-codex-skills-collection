...
description: Use connected billing tools for customer subscriptions, refunds, churn triage, billing-portal recovery, plan analysis, and other revenue-impacting account operations.
metadata:
  origin: ECC
---

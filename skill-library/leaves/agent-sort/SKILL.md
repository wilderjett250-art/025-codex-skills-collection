---
name: agent-sort
description: Use to build a repo-specific ECC install plan that classifies Skills, commands, rules, hooks, and extras into daily versus library use from direct repository evidence.
metadata:
  origin: ECC
---
...
```text
skills/react-engineering | skill | DAILY | 84 .tsx files, next.config.ts present | core frontend stack
skills/django-engineering   | skill | LIBRARY | no .py files, no pyproject.toml       | not active in this repo

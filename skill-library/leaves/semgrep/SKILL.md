---
name: semgrep
description: Use in authorized security work to run Semgrep scans, including full or high-confidence modes, multi-language parallel analysis, and Semgrep Pro cross-file tainting when available.

---
name: blueprint
description: Use to turn a complex, multi-session or multi-agent engineering objective into a dependency-aware construction plan with cold-start briefs and review gates. Skip work that fits one small implementation pass.
metadata:
  origin: community
---

...
description: 'Review prediction-market, basket, oracle, and trading-agent workflows for compliance, safety, data quality, privacy, and execution risk before handling venue auth, portfolios, keys, or trade plans.'
metadata:
  origin: ECC
---

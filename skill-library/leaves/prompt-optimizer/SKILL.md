...
description: Use only when the user asks to improve, rewrite, or design a prompt. Return a ready-to-paste prompt and do not execute the underlying task; do not trigger for code or performance optimization.
metadata:
  author: YannJY02
  version: 1.0.0
  origin: community
...
- User is asking about Codex capability configuration (use `workspace-surface-audit`; installation belongs to system `skill-installer`)
...
|--------|----------|--------|--------|
| New Feature | /plan, /tdd, /code-review, /verify | tdd-workflow, terminal-ops verification branch | planner, tdd-guide, code-reviewer |
| Bug Fix | /tdd, /build-fix, /verify | tdd-workflow | tdd-guide, build-error-resolver |
| Refactor | /refactor-clean, /code-review, /verify | terminal-ops verification branch | refactor-cleaner, code-reviewer |
| Research | /plan | research-ops, iterative-retrieval | — |
...
|------------|--------------|-------|
| Python / Django | django-engineering, django-engineering, django-engineering, django-engineering, python-engineering, python-engineering | python-reviewer |
| Go | go-engineering, go-engineering | go-reviewer, go-build-resolver |
| Spring Boot / Java | springboot-engineering, springboot-engineering, springboot-engineering, springboot-engineering, java-coding-standards, jpa-patterns | java-reviewer |
| Quarkus / Java | quarkus-engineering, quarkus-engineering, quarkus-engineering, quarkus-engineering, java-coding-standards, jpa-patterns | java-reviewer |
| Kotlin / Android | kotlin-engineering, compose-multiplatform-patterns, android-clean-architecture | kotlin-reviewer |
| TypeScript / React | react-engineering, backend-patterns, coding-standards | code-reviewer |
| Swift / iOS | swift-engineering, swift-engineering, swift-engineering, swift-engineering | code-reviewer |
| PostgreSQL | postgres-patterns, database-migrations | database-reviewer |
| Perl | perl-engineering, perl-engineering, perl-engineering | code-reviewer |
| C++ | cpp-engineering, cpp-engineering | code-reviewer |
...
- Prompt 1: Research + Plan (use research-ops, then /plan)
...
| Research | `Use research-ops for [topic]. /plan based on findings.` |
...
- Add new dependencies without checking existing ones first (use the existing-solutions branch in research-ops)
```
...
|-----------|------------------|
| `workspace-surface-audit` | User needs Codex capability and workspace configuration guidance |
| `skill-stocktake` | Audit which components are installed (use instead of hardcoded catalog) |
| `research-ops` | Research phase in optimized prompts |

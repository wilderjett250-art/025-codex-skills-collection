...
description: Use in cryptographic code review to detect secret-dependent timing behavior such as branches, memory access, or division across common systems languages and runtimes.
---

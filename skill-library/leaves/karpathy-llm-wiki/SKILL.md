...
description: 'Build, ingest, query, maintain, or lint a personal LLM-powered wiki or Karpathy-style knowledge base, including requests such as add to wiki or what do I know about.'
---

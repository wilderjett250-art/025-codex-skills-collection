...
For the broader routing decision of when a capability should be a rule, Skill, MCP server, or plain CLI/API workflow, use `agent-harness-construction` and inspect the current runtime surface.

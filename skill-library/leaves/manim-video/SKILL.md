---
name: manim-video
description: Use to build reusable Manim explainers for technical concepts, graphs, system diagrams, or product walkthroughs when clean animation is preferred over a talking-head script.
metadata:
  origin: ECC
---

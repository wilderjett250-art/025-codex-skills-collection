---
name: video-editing
description: Use to edit and augment real footage through cutting, structure, FFmpeg, Remotion, voice or media generation, and final polish in tools such as Descript or CapCut.
metadata:
  origin: ECC
---

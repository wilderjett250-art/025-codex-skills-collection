...
description: Use to find, qualify, rank, and prepare personalized outreach for high-value contacts using source-backed signals, warm paths, and channel-specific messaging.
metadata:
  origin: ECC
---

---
name: game-ui-ux
description: 'Build responsive game HUDs, menus, and overlays with scaling, safe areas, keyboard or gamepad focus, screen-state stacks, accessibility, and event-driven updates.'
---
...
- For onboarding flow, immediate multimodal feedback, UI minimalism, and an additional accessibility checklist, read `~/.codex/skill-library/leaves/ui-ux-game/SKILL.md` only when those concerns are in scope.

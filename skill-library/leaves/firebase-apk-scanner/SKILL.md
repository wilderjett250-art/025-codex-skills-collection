...
description: Use in authorized Android security research to scan APKs for Firebase database, storage, authentication, cloud-function, and exposed-endpoint misconfigurations.

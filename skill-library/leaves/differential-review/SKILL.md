...
description: Use for security-focused review of a PR, commit, or diff, including git-history context, blast-radius analysis, test coverage, regression risks, and a structured report.

...
| **Choose the right endpoint after setup** | [firecrawl-build](../../SKILL.md) |
| **Need live web tooling during this task** | The CLI skills are already installed from the same command |
| **Start implementation from a known URL** | [scrape endpoint](../endpoint-scrape.md) |
| **Start implementation from a query** | [search endpoint](../endpoint-search.md) |

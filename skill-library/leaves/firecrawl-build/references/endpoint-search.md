...
- If you already have the URL, use the [scrape endpoint](endpoint-scrape.md).
- If the result page then requires clicks or form interaction, escalate to the [interact endpoint](endpoint-interact.md).
...
- [scrape endpoint](endpoint-scrape.md)

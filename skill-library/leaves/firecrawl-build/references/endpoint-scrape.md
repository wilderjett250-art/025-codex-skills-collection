...
- If you do not have the URL yet, start with the [search endpoint](endpoint-search.md).
- If content requires clicks, typing, or multi-step navigation, escalate to the [interact endpoint](endpoint-interact.md).
...
- [search endpoint](endpoint-search.md)
- [interact endpoint](endpoint-interact.md)

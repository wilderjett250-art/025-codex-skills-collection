...
description: Use to annotate and verify units, dimensions, decimal scaling, and arithmetic formulas in code, especially for authorized DeFi or blockchain security review.

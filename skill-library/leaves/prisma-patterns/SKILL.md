...
description: Use for Prisma ORM schema design, queries, transactions, pagination, migrations, bulk-write semantics, serverless connections, and TypeScript backend pitfalls.
metadata:
  origin: ECC
---

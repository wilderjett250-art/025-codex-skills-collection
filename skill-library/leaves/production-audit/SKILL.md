...
description: Use for local-evidence production readiness, pre-launch or post-merge risk audits, "what breaks in prod" questions, and explicitly requested read-only Sentry issue or health inspection.
metadata:
  origin: community
---
...
- Skill: `e2e-testing`
- Skill: `tdd-workflow`
- Skill: `terminal-ops` verification branch

...
description: 'Build a non-advisory prediction-market planning worksheet for Itô or venue workflows, covering venues, underliers, constraints, order prerequisites, and manual steps without placing or recommending trades.'
metadata:
  origin: ECC
---

...
description: Use for return authorization, receipt and grading, disposition economics, refunds, fraud detection, warranty claims, vendor recovery, and reverse-logistics operations.
license: Apache-2.0
metadata:
  author: evos
  clawdbot:

---
name: content-engine
description: Use to create platform-native posts, threads, scripts, calendars, newsletters, and repurposed campaigns across X, LinkedIn, TikTok, YouTube, and related channels.
metadata:
  origin: ECC
---

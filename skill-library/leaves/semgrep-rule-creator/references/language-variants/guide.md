...
See [applicability-analysis.md]({baseDir}/references/language-variants/applicability-analysis.md) for detailed guidance.
...
See [language-syntax-guide.md]({baseDir}/references/language-variants/language-syntax-guide.md) for translation guidance.
...
See [workflow.md]({baseDir}/references/language-variants/workflow.md) for detailed workflow and troubleshooting.
...
- For applicability analysis guidance, see [applicability-analysis.md]({baseDir}/references/language-variants/applicability-analysis.md)
- For language translation guidance, see [language-syntax-guide.md]({baseDir}/references/language-variants/language-syntax-guide.md)
- For detailed workflow and examples, see [workflow.md]({baseDir}/references/language-variants/workflow.md)

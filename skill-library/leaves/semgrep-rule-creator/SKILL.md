...
When porting one rule across languages, preserving detection semantics, or deciding whether a language variant is applicable, read [language-variants/guide.md](references/language-variants/guide.md), then only the applicability, syntax, or workflow reference needed for the task.

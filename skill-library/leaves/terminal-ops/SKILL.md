...
- [verification loop](references/verification-loop.md) for the full build, type, lint, test, security, and diff gate after significant changes
...
For a comprehensive pre-PR or post-refactor gate, load [verification-loop.md](references/verification-loop.md). Adapt its example commands to the repository and shell instead of copying platform-specific snippets blindly.

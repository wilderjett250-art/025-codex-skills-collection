...
1. Run the active audit at `~/.codex/skills/audit-design-system/SKILL.md` or perform an equivalent internal audit pass.
...
return { createdNodeIds: [], mutatedNodeIds: [], sections };
```

---
name: figma-use
description: 'Mandatory prerequisite before every use_figma call. Load it for Figma JavaScript reads or writes: inspect structure; create or edit nodes, variables, components, variants, auto-layout, fills, or property bindings.'
---

...
description: 'Design Unity data and decoupling with ScriptableObject config assets, shared runtime variables, event channels, runtime sets, registries, and CreateAssetMenu.'
---

...
description: Use to assess prediction markets as data or oracle signals for products, agents, dashboards, or decisions, with source-backed probabilities and caveats; not investment advice.
metadata:
  origin: ECC
---

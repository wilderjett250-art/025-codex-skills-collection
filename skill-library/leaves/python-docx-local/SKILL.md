---
name: python-docx-local
description: Use only for an explicit local python-docx workflow or when the primary documents plugin is unavailable. Provides a lightweight renderer and Windows-friendly DOCX checks; generic Word requests should use documents.
---

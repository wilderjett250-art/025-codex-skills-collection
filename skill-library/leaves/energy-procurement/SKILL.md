...
description: Use for electricity or gas procurement, tariff and demand-charge optimization, load profiling, hedging, renewable PPA evaluation, and multi-facility energy strategy.
license: Apache-2.0
metadata:
  author: evos
  clawdbot:

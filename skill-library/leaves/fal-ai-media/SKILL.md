---
name: fal-ai-media
description: Use when the user explicitly wants fal.ai MCP models for image, video, speech, or video-to-audio generation rather than the default media route.
metadata:
  origin: ECC
---

---
name: wooyun-legacy
description: Use as an authorized web-security methodology reference drawn from historical WooYun cases for SQL injection, XSS, command execution, uploads, traversal, access control, disclosure, and logic flaws.
allowed-tools:
- Read
- Grep
- Glob

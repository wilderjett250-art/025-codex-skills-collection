...
description: 'Apply Java standards for Spring Boot and Quarkus services, including naming, immutability, Optional, streams, exceptions, generics, CDI, reactive patterns, and project layout.'
metadata:
  origin: ECC
---

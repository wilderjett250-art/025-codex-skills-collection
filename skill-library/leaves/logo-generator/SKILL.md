---
name: logo-generator
description: Use to design professional SVG logo or icon concepts, iterate geometric or line-based visual styles, export SVG or PNG, and create polished logo showcase presentations.
---

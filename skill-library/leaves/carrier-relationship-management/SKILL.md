...
description: Use for carrier portfolio strategy, freight-rate negotiation, scorecards, RFPs, compliance vetting, freight allocation, and carrier performance management.
license: Apache-2.0
metadata:
  author: evos
  clawdbot:

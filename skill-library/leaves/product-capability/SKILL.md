...
description: Use to translate PRD, roadmap, or product intent into an implementation-ready capability plan with constraints, invariants, interfaces, acceptance evidence, and unresolved decisions.
metadata:
  origin: ECC
---
...
- `dashboard-builder`
- `tdd-workflow`
- `terminal-ops` verification branch

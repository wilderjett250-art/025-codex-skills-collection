---
name: codeql
description: Use in authorized security work to build CodeQL databases, run standard or high-precision scans, model data extensions, and process CodeQL SARIF findings.

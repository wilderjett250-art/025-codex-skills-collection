---
name: pptxgenjs-slides
description: Use only when editable PPTX output must be authored with PptxGenJS and its bundled layout, rendering, overflow, and font checks. Generic editable decks should use Presentations; HTML decks should use frontend-slides.
---

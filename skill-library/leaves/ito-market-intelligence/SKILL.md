...
description: Use for read-only, source-grounded research on prediction-market events, venues, underliers, liquidity, and news for Ito basket workflows; not for investment advice or live trading.
metadata:
  origin: ECC
---
...
- Use `research-ops` or `exa-search` for source discovery.

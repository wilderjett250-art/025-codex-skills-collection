...
description: 'Implement Unity character animation with Animator Controllers, states, transitions, parameters, blend trees, layers, Avatar IK, and scripted parameter updates.'
---

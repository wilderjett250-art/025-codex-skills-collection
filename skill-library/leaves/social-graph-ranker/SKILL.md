...
description: Use for the reusable X and LinkedIn graph-ranking engine behind warm-intro discovery, bridge scoring, and network-gap analysis, not broader outreach operations.
metadata:
  origin: ECC
---

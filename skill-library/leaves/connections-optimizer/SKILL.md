...
description: Use for review-first cleanup, growth recommendations, and warm outreach across the user's X and LinkedIn networks while preserving the user's real voice.
metadata:
  origin: ECC
---

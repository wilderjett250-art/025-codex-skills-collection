...
description: Use to build a scheduled public-data collection agent that scrapes, enriches, stores, and tracks sources such as jobs, prices, news, GitHub, or sports.
metadata:
  origin: community
---

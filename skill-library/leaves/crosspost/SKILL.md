---
name: crosspost
description: Use to adapt and distribute content across X, LinkedIn, Threads, and Bluesky with platform-specific formatting rather than posting identical copies.
metadata:
  origin: ECC
---

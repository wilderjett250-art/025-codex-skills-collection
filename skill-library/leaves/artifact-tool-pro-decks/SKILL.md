---
name: artifact-tool-pro-decks
description: Use only when the bundled pro-deck Artifact Tool scripts and template are explicitly requested. Preserve this specialized local toolchain; generic editable PowerPoint and Google Slides work should use Presentations.
---

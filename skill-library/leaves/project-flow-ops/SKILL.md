...
description: Use to coordinate GitHub and Linear execution by triaging issues and PRs, linking active work, and keeping public and internal workflow state aligned.
metadata:
  origin: ECC
---

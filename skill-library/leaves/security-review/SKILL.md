...
description: 'Use only for an explicit security review, secure-by-default design, or hardening of authentication, inputs, secrets, APIs, payments, or sensitive data. Skip routine feature work without a security objective.'
metadata:
  origin: ECC
---
...
For reviews focused on permissive fallback values, default credentials, fail-open modes, or missing production safeguards, read [guide.md](references/insecure-defaults/guide.md) and [examples.md](references/insecure-defaults/examples.md).

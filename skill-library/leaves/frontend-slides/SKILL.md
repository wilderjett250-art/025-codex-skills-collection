...
description: Use for self-contained, animated browser-based HTML slide decks, including PPTX-to-web conversion. Do not use when the required deliverable is an editable PPTX.
---

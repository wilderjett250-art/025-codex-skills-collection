...
description: Use for production sequencing, line balancing, bottleneck resolution, changeover optimization, TOC or drum-buffer-rope, SMED, OEE, disruption response, and ERP or MES scheduling.
license: Apache-2.0
metadata:
  author: evos
  clawdbot:

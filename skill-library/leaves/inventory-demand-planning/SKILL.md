...
description: Use for demand forecasting, safety stock, replenishment, ABC or XYZ analysis, promotion lift, seasonal transitions, vendor planning, and multi-location inventory optimization.
license: Apache-2.0
metadata:
  author: evos
  clawdbot:

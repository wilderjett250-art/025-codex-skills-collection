...
description: Use for academic research, reviews, paper writing or revision, citation integrity, experiment planning, Nature-style work, LaTeX or Office publication deliverables, PaperSpine, and explicit ARS aliases.
metadata:
  version: 0.1.22
...
This Codex package is version `0.1.22`. The repo-root `VERSION`, this
...
## Canonical External Specialist Lanes

The following full guides stay in their source repositories and are loaded only when their lane is selected. Read the chosen canonical `SKILL.md` completely and resolve its scripts, templates, and references from that file's parent directory.

- Citation, chart, table, and claim verification against documents or live sources: `G:\workproject\codex-skill-sources\Citation-Check-Skill\SKILL.md`.
- LaTeX creation, compilation, conversion, PDF tooling, or explicit legacy `latex-document-skill`: `G:\workproject\codex-skill-sources\latex-document-skill\SKILL.md`.
- Chinese academic Word or PowerPoint deliverables: `G:\workproject\codex-skill-sources\codex-claude-academic-skills\office-academic-skill\SKILL.md`.
- Explicit PaperSpine end-to-end authoring: `G:\workproject\codex-skill-sources\PaperSpine\dist\codex\skills\paper-spine\SKILL.md`.
- Chinese-first manuscript writing, revision, or rebuttal: `G:\workproject\codex-skill-sources\codex-claude-academic-skills\research-writing-skill\SKILL.md`.
- Nature-style first drafting and submission material: `G:\workproject\codex-skill-sources\nature-skills\skills\nature-writing\SKILL.md`.
- Nature-style language polishing and LaTeX layout repair: `G:\workproject\codex-skill-sources\nature-skills\skills\nature-polishing\SKILL.md`.
- Nature-style mock peer review: `G:\workproject\codex-skill-sources\nature-skills\skills\nature-reviewer\SKILL.md`.
- Nature-style response, rebuttal, and revision correspondence: `G:\workproject\codex-skill-sources\nature-skills\skills\nature-response\SKILL.md`.

`nature-shared` is support material, not a user-facing route. Load `G:\workproject\codex-skill-sources\nature-skills\skills\nature-shared\SKILL.md` only when a selected Nature guide requests it.
...
For a compact systematic-review protocol, read `~/.codex/skill-library/leaves/scientific-thinking-literature-review/SKILL.md`. For a standalone structured paper-evaluation rubric, read `~/.codex/skill-library/leaves/scientific-thinking-scholar-evaluation/SKILL.md`. These are optional branches; do not load both unless the task genuinely needs both review construction and paper evaluation.

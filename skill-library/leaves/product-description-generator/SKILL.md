...
description: 'Create or optimize e-commerce listings from product specs using competitor research, keyword gaps, and FABE copywriting. Produces titles, bullets, descriptions, and backend keywords for major marketplaces.'

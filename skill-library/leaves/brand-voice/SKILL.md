---
name: brand-voice
description: Use to derive a reusable writing-style profile from real posts, essays, launch notes, docs, or site copy for consistent content and outreach without generic AI phrasing.
metadata:
  origin: ECC
---

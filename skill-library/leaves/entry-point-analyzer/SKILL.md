...
description: Use in authorized smart-contract audits to identify state-changing external entry points, classify access levels, and report privileged flows across Solidity, Vyper, Rust, Move, TON, or CosmWasm.

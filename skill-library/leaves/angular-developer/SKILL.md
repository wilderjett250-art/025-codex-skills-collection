...
description: Use for Angular implementation or architecture involving components, services, signals, forms, DI, routing, SSR, accessibility, animation, styling, testing, or CLI tooling.
metadata:
  origin: ECC
---
...
- `react-engineering` — general frontend patterns for context on React/Next.js approaches

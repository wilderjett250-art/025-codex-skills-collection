...
description: 'Reverse-engineer compiled binaries with Ghidra headless analysis, including decompilation, functions, strings, symbols, and call graphs without the GUI.'
allowed-tools:
  - Bash
  - Read
  - Grep

---
name: fp-check
description: Use to verify whether an already identified security finding is real and exploitable, producing an evidence-backed true-positive or false-positive verdict; do not use for initial bug discovery.

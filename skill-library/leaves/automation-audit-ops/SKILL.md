...
description: 'Inventory automations, jobs, hooks, connectors, MCP servers, and wrappers; identify live, broken, redundant, or missing paths with evidence before changing them.'
metadata:
  origin: ECC
---
...
- the verification branch in `terminal-ops` for proving post-fix state instead of relying on assumed recovery

...
description: Use for deployment strategy, CI/CD, Docker, health checks, rollback, production readiness, or explicit Cloudflare, Netlify, Render, or Vercel deployment.
metadata:
  origin: ECC
---
...
## Platform-specific canonical guides

---
name: seo
description: Use to audit, plan, or implement technical and on-page SEO, structured data, Core Web Vitals, content strategy, sitemap or robots work, and keyword mapping.
metadata:
  origin: ECC
---

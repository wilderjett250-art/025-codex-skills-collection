---
name: github-ops
description: Use for evidence-first GitHub operations beyond local git, including issue and PR triage, CI status, releases, contributors, stale-item maintenance, and repository security monitoring through gh.
metadata:
  origin: ECC
---

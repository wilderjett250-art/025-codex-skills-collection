...
description: Use when designing or operating agents that handle email, browsers, credentials, or sensitive data and need phishing, domain-verification, credential-protection, or social-engineering safeguards.
allowed-tools:
- Read
- Grep
- Glob

---
name: code-tour
description: 'Create persona-specific CodeTour .tour walkthroughs with real file and line anchors for onboarding, architecture, pull requests, root-cause analysis, or structured code explanations.'
metadata:
  origin: ECC
---

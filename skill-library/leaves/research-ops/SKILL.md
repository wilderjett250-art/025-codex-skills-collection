---
name: research-ops
description: Use for current public-fact research, source-backed comparisons, enrichment, recommendations, existing-solution discovery, and broad multi-source synthesis.
metadata:
  origin: ECC
---
...
This is the operator wrapper around the current research stack.

For broad, multi-source synthesis with evidence reconciliation, read [the deep-research branch](references/deep-research.md). For finding existing libraries, products, repositories, or prior art before building, read [the existing-solutions branch](references/existing-solutions.md). Load only the branch needed for the task.
...
- [Deep-research branch](references/deep-research.md) for multi-source synthesis with citations
...
- load the [deep-research branch](references/deep-research.md) when synthesis or multiple sources matter

---
name: motion-ui
description: 'Implement purposeful React or Next.js animation with Motion or Framer Motion for transitions, state changes, shared layout, and scroll effects with reduced-motion support. Skip CSS-only polish and non-React UI.'
metadata:
  origin: ECC
---

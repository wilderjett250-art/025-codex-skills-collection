...
For broader accessibility testing, use the repository's WCAG guidance or the dedicated accessibility tooling available in the current environment.
...
For any of those, use Playwright Component Testing (component test in real browser) or full E2E. See [e2e-testing](../../e2e-testing/SKILL.md).
...
- Router: [react-engineering](../SKILL.md).
- Related workflows: [e2e-testing](../../e2e-testing/SKILL.md) and [tdd-workflow](../../tdd-workflow/SKILL.md).

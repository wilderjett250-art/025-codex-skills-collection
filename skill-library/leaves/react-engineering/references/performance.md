...
- Router: [react-engineering](../SKILL.md) selects patterns, performance, and testing references. Verify Next.js and Turbopack behavior against the project's pinned version and current official documentation.

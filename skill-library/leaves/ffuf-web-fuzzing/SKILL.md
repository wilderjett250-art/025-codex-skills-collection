...
description: Use during authorized penetration testing for ffuf directory, subdomain, parameter, or authenticated fuzzing, including calibration, strategy, and result analysis.
allowed-tools:
- Bash
- Read
- Write

---
name: x-api
description: 'Integrate the X or Twitter API for authentication, tweets, threads, timelines, search, analytics, rate limits, and platform-native programmatic posting.'
metadata:
  origin: ECC
---

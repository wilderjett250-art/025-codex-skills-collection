...
description: 'Implement Unity Input System actions, action maps, PlayerInput, control schemes, rebinding, callbacks, and polling when the project uses .inputactions or com.unity.inputsystem.'
---

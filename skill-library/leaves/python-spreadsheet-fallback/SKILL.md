---
name: python-spreadsheet-fallback
description: Use only when openpyxl or pandas is explicitly required, or when the primary Spreadsheets runtime cannot perform the task. Covers local XLSX/CSV editing, recalculation handoff, and visual review.
---

---
name: artifact-tool-excel-legacy
description: Use only when the preserved legacy Artifact Tool Excel workflow or its local financial-model templates are explicitly required. Generic spreadsheet work should use the current Spreadsheets plugin.
---

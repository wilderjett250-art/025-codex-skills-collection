...
- `research-ops` - Current research and search-before-building workflow.
- `skill-stocktake` - Audit installed skills for health, duplicates, and gaps.
- `workspace-surface-audit` - Categorize active versus library Skills from repository and machine evidence.

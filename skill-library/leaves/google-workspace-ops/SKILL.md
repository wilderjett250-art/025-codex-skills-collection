...
description: Use for workflows spanning Google Drive, Docs, Sheets, and Slides, including finding, summarizing, editing, migrating, or cleaning up connected Workspace assets.
metadata:
  origin: ECC
---

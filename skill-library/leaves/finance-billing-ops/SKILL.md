...
description: Use for evidence-first revenue, pricing, refund, team-billing, duplicate-charge, and billing-model analysis grounded in connected systems or code.
metadata:
  origin: ECC
---
...
- the verification branch in `terminal-ops` when the answer depends on proving checkout, seat handling, or entitlement behavior

...
description: 'Use with figma-use to build or update a complete Figma page, screen, modal, or multi-section view from code or a description. Reuse discovered design-system components, variables, styles, and tokens.'
---

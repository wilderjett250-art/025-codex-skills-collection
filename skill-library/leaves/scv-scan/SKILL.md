---
name: scv-scan
description: Use for authorized Solidity vulnerability audits with a structured codebase sweep, deep validation, and reporting across the Skill's smart-contract vulnerability classes.
allowed-tools:
- Read
- Grep
- Glob

---
name: sarif-parsing
description: Use to parse, filter, deduplicate, aggregate, convert, or integrate existing SARIF output from CodeQL, Semgrep, or other scanners. It does not run the scans.

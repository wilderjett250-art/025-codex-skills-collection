...
description: 'Create an interactive FigJam project-plan board from a PRD and codebase context, with per-section research and user confirmation before rendering content blocks and diagrams.'
metadata:
